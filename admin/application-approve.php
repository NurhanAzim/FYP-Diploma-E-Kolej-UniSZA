                ...
                <tbody>
                    ...
                    ?>
                            <form action="code-application-admin.php" method="POST">
                                <tr>
                                    <td>Id Permohonan</td>
                                    <td><input type="hidden" id="appId" name="appId" value="<?= $row['appId'] ?>"></td>
                                </tr>
                                <tr>
                                    <td>Id Pemohon</td>
                                    <td><?= $row['userId'] ?></td>
                                ...
                                <tr>
                                    <td colspan="5"><button name="application_approve-btn" class="btn btn-primary">Simpan Status Permohonan</button></td>
                                </tr>
                            </form>
                    <?php
                        }
